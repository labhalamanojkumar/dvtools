...
export const toolsConfig: Record<string, {
  ...
  "onboarding-checklist-generator": {
    ...
    description: "Create and manage onboarding checklists with progress tracking and analytics",
    category: "Collaboration",
    icon: "✅",
    features: ["Template creation", "Progress tracking", "Analytics", "Assignment management"],
    keywords: ["onboarding", "checklist", "template", "progress", "analytics"],
    requiresAPI: true
  },
  "enhanced-onboarding-checklist-generator": {
    name: "Enhanced Onboarding Checklist Generator",
    description: "Advanced checklist management with real-time collaboration, multiple file format support, drag-and-drop reordering, advanced analytics, and notification system.",
    category: "Collaboration",
    icon: "⚡",
    features: [
    ...
    keywords: [
      "onboarding", "checklist", "template", "real-time", "collaboration", 
      "file import", "analytics", "drag-drop", "notifications", "bulk operations",
      "export", "search", "filtering", "versioning", "priority", "comments"
    ],
    acceptedFileTypes: [
      "application/json", 
      "text/csv", 
