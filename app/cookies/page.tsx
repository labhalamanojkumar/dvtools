...
const cookieCategories = [
  ...
  },
  {
    ...
    purpose:
      "Analyze website usage, improve performance, and develop new features.",
    examples: [
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-blue-800 dark:text-blue-200 text-sm mt-1">
                  We respect your privacy and give you control over your cookie
                  preferences. Essential cookies cannot be disabled as they are
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <p className="mb-4">
            ...
            services help us analyze website usage, process payments, and
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                ...
                settings preferences. You can usually find these settings in the
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                For third-party services, you can use the opt-out links provided
                above to disable their cookies.
              </p>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-yellow-800 dark:text-yellow-200 text-sm mt-1">
                  ...
                  website and limit your user&apos;s experience.
                </p>
              </div>
            </div>
          </div>
