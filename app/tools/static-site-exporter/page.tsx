...
export const metadata: Metadata = {
  ...
  description: 'Transform your dynamic websites into static HTML files. Export complete websites with assets, minify code, and create self-contained static sites. Perfect for hosting on CDNs, GitHub Pages, or any static hosting service.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Transform dynamic websites into static HTML files with asset extraction, minification, and optimization for static hosting.',
  ...
  twitter: {
    ...
    title: 'Static Site Exporter - Convert Websites to Static HTML',
    description: 'Transform dynamic websites into static HTML files with asset extraction, minification, and optimization.',
...
const jsonLd = {
  ...
  description: 'Convert dynamic websites to static HTML files with asset extraction and optimization',
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-6">
          Transform your dynamic websites into static HTML files. Extract assets, minify code,
          and create self-contained static sites perfect for CDN hosting, GitHub Pages, or any static hosting service.
        </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="prose prose-lg max-w-none">
            <p>
              Static site export transforms dynamic web applications into static HTML files that can be served
              directly from any web server or CDN. This process eliminates the need for server-side processing,
        ...
        <div>
          <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-6 rounded-lg mb-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Export Capabilities</h3>
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-100 p-6 rounded-lg">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600 mb-4">Faster Load Times</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Upload your HTML file or paste the code. The tool analyzes the structure and identifies
              embedded styles, scripts, and assets.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Apply minification, asset extraction, and optimization settings. Remove unnecessary
              scripts, inline critical CSS, and encode images.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">
              Generate optimized static files. Download as a single HTML file or complete ZIP package
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Asset Management</h3>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Optimization Features</h3>
            <ul className="space-y-2 text-gray-600">
      ...
      <div className="bg-blue-50 rounded-lg p-8 mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Marketing Sites</h3>
            <p className="text-gray-600 mb-4">
              Create fast-loading landing pages and campaign sites that convert visitors
              without server dependencies.
            </p>
            <div className="text-sm text-blue-600 font-medium">→ 300% faster load times</div>
          </div>

          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Documentation</h3>
            <p className="text-gray-600 mb-4">
              Host API docs, user guides, and help centers that are always available
              and searchable by search engines.
            </p>
            <div className="text-sm text-green-600 font-medium">→ Perfect SEO scores</div>
          </div>

          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Portfolio Websites</h3>
            <p className="text-gray-600 mb-4">
              Showcase your work with beautiful, fast-loading portfolio sites hosted
              on free platforms like GitHub Pages.
            </p>
            <div className="text-sm text-purple-600 font-medium">→ Zero hosting costs</div>
          </div>

          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Event Pages</h3>
            <p className="text-gray-600 mb-4">
              Create event microsites and registration pages that handle traffic spikes
              without server scaling concerns.
            </p>
            <div className="text-sm text-orange-600 font-medium">→ Unlimited scalability</div>
          </div>

          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Prototypes & Demos</h3>
            <p className="text-gray-600 mb-4">
              Share interactive prototypes and product demos as self-contained files
              that work offline and load instantly.
            </p>
            <div className="text-sm text-red-600 font-medium">→ Offline capable</div>
          </div>

          <div className="bg-white p-6 rounded-lg shadow-sm">
            <h3 className="text-lg font-semibold text-gray-900 mb-3">Backup Archives</h3>
            <p className="text-gray-600 mb-4">
              Create permanent archives of websites that will remain accessible
              even if the original servers go down.
            </p>
            <div className="text-sm text-indigo-600 font-medium">→ Permanent preservation</div>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          <details className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="mt-4 text-gray-600">
              Any website that can be rendered as HTML can be exported. This includes static sites,
              dynamic sites with client-side JavaScript, and even complex web applications.
              The tool works best with content that doesn&apos;t require server-side processing.
            </div>
          </details>
          ...
          <details className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="mt-4 text-gray-600">
              Client-side JavaScript functionality will be preserved unless you choose to remove scripts.
              Server-side features like forms, databases, and authentication will not work in the static version.
              Consider these as &quot;read-only&quot; versions of your dynamic sites.
            </div>
          </details>
          ...
          <details className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="mt-4 text-gray-600">
              Single HTML creates one self-contained file with all assets embedded (Base64 images, inline CSS).
              ZIP export creates separate files for HTML, CSS, JavaScript, and assets, which is better for
          ...
          <details className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="mt-4 text-gray-600">
              Yes! Static sites can be hosted on any web server, CDN, or static hosting service including:
              GitHub Pages, Netlify, Vercel, AWS S3, Google Cloud Storage, Azure Static Web Apps,
              and traditional web hosting providers.
            </div>
          </details>
          ...
          <details className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <div className="mt-4 text-gray-600">
              Minification typically reduces file sizes by 20-50%. Additional optimizations like Base64
              encoding for small images and asset extraction can further optimize loading. The exact
              savings depend on your original code quality and chosen options.
            </div>
          </details>
        </div>
      </div>
      ...
      <div className="text-center bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg p-8">
        ...
        <p className="text-lg mb-6 opacity-90">
          Transform your dynamic website into a fast, reliable static site in seconds.
          Perfect for marketing pages, portfolios, documentation, and more.
        </p>
