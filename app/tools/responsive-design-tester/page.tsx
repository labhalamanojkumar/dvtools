...
export const metadata: Metadata = {
  ...
  description:
    "Test your website responsiveness across different devices and screen sizes. Preview how your site looks on phones, tablets, and desktops with our interactive device emulator.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Test website responsiveness across phones, tablets, and desktops with live previews",
    type: "website",
  },
  alternates: {
...
const jsonLdSchema = {
  ...
  description:
    "Interactive responsive design testing tool with device emulation and live previews",
};
      ...
      <div className="tool-container">
        <div className="tool-header">
          ...
          <p className="tool-description">
            Test your website&apos;s responsiveness across different devices and
            screen sizes with interactive previews and device emulation
          </p>
        </div>
