    ...
    <div className="container mx-auto px-4 py-12">
      <div className="mb-12 text-center">
        ...
        <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
          Professional-grade tools for developers. All tools are free, secure, and process data locally in your browser.
        </p>
      </div>
...
export const metadata = {
  title: 'Developer Tools - Free Online Tools for Developers | Multi Tool Platform',
  description: 'Free online developer tools for JSON formatting, Base64 encoding, JWT decoding, CSS optimization, accessibility testing, performance profiling, and more. All tools are secure and process data locally.',
  keywords: [
    'developer tools',
    'online tools',
    'JSON formatter',
  ...
  openGraph: {
    ...
    description: 'Professional-grade developer tools for JSON, CSS, accessibility testing, performance analysis, and more. All tools are free, secure, and work offline.',
    url: '/tools',
  ...
  twitter: {
    ...
    title: 'Developer Tools - Free Online Tools for Developers',
    description: 'Professional-grade developer tools for JSON, CSS, accessibility testing, performance analysis, and more.',
    images: ['/og-tools.jpg'],
  },
  robots: {
    index: true,
