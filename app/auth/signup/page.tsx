...
export const metadata: Metadata = {
  ...
  description: 'Join DevTools Hub and get access to professional developer tools. Create your account to start using our comprehensive suite of development utilities.',
  keywords: [
    'sign up',
    'register',
    'create account',
  ...
  openGraph: {
    title: 'Sign Up | DevTools Hub - Create Your Account',
    description: 'Join DevTools Hub and get access to professional developer tools.',
    type: 'website',
    url: '/auth/signup',
        ...
        <div className="hidden lg:block space-y-8">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Get access to professional developer tools and start building better software faster.
            </p>
          </div>
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
            ...
            <p className="text-sm text-muted-foreground">
              Enjoy all features completely free during our limited time promotion.
