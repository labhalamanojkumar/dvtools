          ...
          {status === "loading" ? (
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                ...
                <DropdownMenuItem asChild>
                  <a href="/dashboard" suppressHydrationWarning>
                    <BarChart3 className="mr-2 h-4 w-4" />
                    <span>Dashboard</span>
                  </a>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <a href="/profile" suppressHydrationWarning>
                    <User className="mr-2 h-4 w-4" />
                    <span>Profile</span>
                  </a>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <a href="/settings" suppressHydrationWarning>
            ...
            <div className="flex items-center space-x-2">
              <Button variant="ghost" size="sm" asChild>
                <a href="/auth/signin" suppressHydrationWarning>Sign In</a>
              </Button>
              <Button size="sm" asChild>
                <a href="/auth/signup" suppressHydrationWarning>Sign Up</a>
              </Button>
            </div>
          )}
