        ...
        <Card>
          <CardContent className="p-6">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              <Button onClick={decodeUrl} variant="outline">Decode Component</Button>
              <Button onClick={encodeFullUrl} variant="secondary">Encode Full URL</Button>
              <Button onClick={decodeFullUrl} variant="secondary">Decode Full URL</Button>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="mb-4 flex items-center justify-between">
              ...
              {output && (
                <div className="flex gap-2">
                  ...
                  <Button size="sm" variant="ghost" onClick={() => downloadFile(output, 'url-output.txt', 'text/plain')}>
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              <div>
                ...
                <div className="text-sm text-muted-foreground">Hello World! How are you?</div>
              </div>
            </Button>
            <Button
              variant="outline"
            ...
            >
              <div>
                ...
                <div className="text-sm text-muted-foreground">URL parameters</div>
              </div>
            </Button>
            <Button
              variant="outline"
              className="justify-start text-left h-auto p-4"
              onClick={() => setInput('https://example.com/path with spaces/file?name=value')}
            >
              <div>
                <div className="font-semibold">Full URL</div>
                <div className="text-sm text-muted-foreground">Complete URL with spaces</div>
              </div>
            </Button>
          </div>
        </CardContent>
        ...
        <CardContent className="p-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Encodes characters that have special meaning in URLs except: ; , / ? : @ & = + $ - _ . ! ~ * &apos; ( ) #
              </p>
            </div>
          </div>
        </CardContent>
